...
/// - Does not log internally (caller decides what to log)
/// </summary>
[ExcludeFromCodeCoverage]
public abstract class BaseHttpServiceV2
{
    protected readonly string _baseUrl;
    protected readonly HttpClient _httpClient;
    protected readonly IHttpContextAccessor _httpContextAccessor;

    protected BaseHttpServiceV2(
    ...
    )
    {
        ...
        _baseUrl = baseUrl.TrimEnd('/') + "/" + endPointName.Trim('/');
    }
