...
public class ConfigurationService : IConfigurationService
{
    ...
    public ConfigurationService(IConfiguration configuration, SecretClient? keyVaultClient = null)
    {
        ...
        _keyVaultClient = keyVaultClient ?? new SecretClient(new Uri(keyVaultUrl), new DefaultAzureCredential());
    }
