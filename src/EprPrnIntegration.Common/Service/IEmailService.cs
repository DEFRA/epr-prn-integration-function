...
public interface IEmailService
{
    ...
    void SendCancelledPrnsNotificationEmails(
    ...
    void SendIssuedPrnsReconciliationEmailToNpwd(
        DateTime reportDate,
        int reportCount,
        string reportCsv
    );
    ...
    void SendUpdatedPrnsReconciliationEmailToNpwd(
        DateTime reportDate,
        string reportCsv,
        int rowCount
    );
    ...
    void SendUpdatedOrganisationsReconciliationEmailToNpwd(
        DateTime reportDate,
